...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
            ...
            `,extensions:{derivatives:!0}});super(s,o),this.frustumCulled=!1}}let yi,mi,$n;function Fw(){yi=new Aw,mi=new mn(60,window.innerWidth/window.innerHeight,.1,1e3),mi.position.set(0,3,8),mi.rotation.order="YXZ",$n=new qg,$n.setSize(window.innerWidth,window.innerHeight),$n.toneMappingExposure=1,$n.shadowMap.enabled=!0,$n.shadowMap.type=Eg,document.body.appendChild($n.domElement);const t=new kw;t.position.set(8.5,-.5,8.5),yi.add(t);const e=new _n(new Po(1e5,1e5),new Lo({color:16776960,side:On,visible:!1}));e.rotation.set(Math.PI/2,0,0),e.position.set(0,-.5,0),e.name="helpPlane",yi.add(e),n();function n(){requestAnimationFrame(n),$n.render(yi,mi)}window.addEventListener("resize",i),document.oncontextmenu=document.body.oncontextmenu=function(){return!1},window.addEventListener("beforeunload",function(r){return r.stopPropagation(),r.preventDefault(),!1},!0);function i(){mi.aspect=window.innerWidth/window.innerHeight,mi.updateProjectionMatrix(),At.update(),$n.setSize(window.innerWidth,window.innerHeight)}}let At;const zw=new Rw;let dp=!0,Zi;$g("deepslate_diamond_ore.png");async function $g(t){let n=`${window.location.hostname==="localhost"?".":{}.PUBLIC_URL}/assets/textures/${t}`,i=await Mg(()=>import(n),[]);zw.load(i.default,r=>{r&&(Zi=r,Zi&&(Zi.minFilter=vt,Zi.magFilter=vt,Bt.material.map=Zi,Bt.material.opacity=.5,Bt.material.transparent=!0,Bt.material.wireframe=!1,Bt.material.needsUpdate=!0),dp&&(Ow(),kc(0,0,0),dp=!1))})}function kc(t,e,n){let i=new _n(new Sr(1,1,1),new Lo({map:Zi}));i.name="block",yi.add(i),i.position.set(t,e,n)}let So=!1,Bt=new _n(new Sr(1,1,1),new Lo({color:"white",wireframe:!0}));Bt.name="hoverBlock";function Ow(){At=new Nw(mi,$n.domElement),At.target.set(0,0,0),At.update(),At.autoRotate=!1,At.autoRotateSpeed=1,At.enableDamping=!0,At.dampingFactor=.05,At.enablePan=!0,document.addEventListener("keydown",t=>{t.keyCode===16&&(So=!0,At.mouseButtons={LEFT:2,MIDDLE:1,RIGHT:0})}),document.addEventListener("keyup",t=>{t.keyCode===16&&(So=!1,At.mouseButtons={LEFT:void 0,MIDDLE:1,RIGHT:void 0})}),At.mouseButtons={LEFT:void 0,MIDDLE:1,RIGHT:void 0},At.touches={ONE:void 0,TWO:void 0},At.screenSpacePanning=!1,At.minDistance=1,At.maxDistance=200,document.querySelector("canvas")?.addEventListener("mousemove",Vw),yi.add(Bt),document.querySelector("canvas")?.addEventListener("click",Uw),document.querySelector("canvas")?.addEventListener("contextmenu",Bw)}const hp=new Iw,Lu=new Ae;function kf(t,e){Lu.x=t.clientX/window.innerWidth*2-1,Lu.y=-(t.clientY/window.innerHeight)*2+1,hp.setFromCamera(Lu,mi);let n=hp.intersectObjects(yi.children);return n=n.filter(i=>i.object.name!=="hoverBlock"),n[0]}function Uw(t){if(!So){let e=kf(t);e&&(e.object.name=="helpPlane"?kc(Math.round(e.point.x),Math.abs(Math.round(e.point.y+.001)),Math.round(e.point.z)):e.face&&kc(Math.round(e.object.position.x+e.face.normal.x),Math.abs(Math.round(e.object.position.y+.001+e.face.normal.y)),Math.round(e.object.position.z+e.face.normal.z)))}}function Bw(t){if(!So){let e=kf(t);e&&e.object.name!=="helpPlane"&&e.object.name!=="hoverBlock"&&yi.remove(e.object)}}function Vw(t){if(!So){let e=kf(t);e&&(e.object.name=="helpPlane"?Bt.position.set(Math.round(e.point.x),Math.abs(Math.round(e.point.y+.001)),Math.round(e.point.z)):(Bt.material.map=Zi,Bt.material.opacity=.5,Bt.material.transparent=!0,Bt.material.wireframe=!1,Bt.material.needsUpdate=!0,e.face&&Bt.position.set(Math.round(e.object.position.x+e.face.normal.x),Math.abs(Math.round(e.object.position.y+.001+e.face.normal.y)),Math.round(e.object.position.z+e.face.normal.z))))}}let Pu="deepslate_diamond_ore.png",Gw=20;const Hw=()=>{const[t,e]=ar.useState([]);return ar.useEffect(()=>{(async()=>{const r=(await Mg(()=>import("./textures-5599cd7a.js"),[])).default;e(r)})()},[]),Si("div",{className:"grid grid-cols-4",children:t.map(n=>T0("div",{onClick:Ww,className:"relative basis-1/3 flex flex-wrap justify-center",children:[Si("img",{src:n.path,alt:"block",className:"w-12 h-12 select-none"}),Si("label",{className:"break-words text-sm select-none",children:n.name.slice(0,n.name.length-4).replaceAll("_"," ")})]},n.name))})};function Ww(t){Pu=t.currentTarget.querySelector("label").innerText,Pu=t.currentTarget.querySelector("img").getAttribute("src").slice(Gw),$g(Pu)}function jw(){return Si("div",{className:"App h-full w-full",children:Si("div",{className:"leftBlock relative h-full w-14% bg-gray-300 overflow-scroll overflow-x-hidden",children:Si(Hw,{})})})}Fw();Du.createRoot(document.getElementById("root")).render(Si(v0.StrictMode,{children:Si(jw,{})}));
